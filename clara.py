...
def read_arguments():
    ...
    parser.add_argument('-v', '--verbose', action='store_true', default=False) #type=int, default=15000)
    parser.add_argument('-i', '--clara_iterations', type=int, default=2)
    parser.add_argument('-c', '--cost_type', type=str, default='modularity')
